...
configuration properties to set within your application. If you have a large amount of custom HTTP
configuration for SCIM integration in your code, you may be able to remove some properties. 
