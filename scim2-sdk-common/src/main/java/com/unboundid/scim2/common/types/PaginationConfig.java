 ...
 * with HTTP infrastructure rejecting messages. Furthermore, generating massive
 * amounts of data increases processing time, resulting in latency that is often
 * undesirable. Pagination allows services and clients to easily handle large
 ...
 *   <li> Returns no more than 250 elements in a page.
