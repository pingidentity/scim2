 ...
 * request would have resulted in an invalid state. This exception type should
 * generally be caught and re-thrown as a {@link BadRequestException} to
 * indicate an invalid data form from a client request.
 * <br><br>
 *
 ...
 * specific errors, such as in controller advice classes in Spring-based
 * applications.
 *
