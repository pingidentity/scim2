 ...
 * <pre><code>
 *   ListResponse&lt;UserResource&gt; response =
 *       new ListResponse&lt;&gt;(100, "YkU3OF86Pz0rGv", 1, getUsers());
 * </code></pre>
 *
 ...
 * <pre><code>
 *   ListResponse&lt;UserResource&gt; response =
 *       new ListResponse&lt;&gt;(100, getUsers(), 12, 1);
 * </code></pre>
 *
    ...
    implements Iterable<T>
{
   ...
   *                      requesting index-based pagination.
   ...
   *        possible for a SCIM service to only support "next" values.
   * </ul>
   *
